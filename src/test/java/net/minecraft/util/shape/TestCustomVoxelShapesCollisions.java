...
import ga.ozli.minecraftmods.swift.common.lithium.shapes.VoxelShapeAlignedCuboid_Offset;
import ga.ozli.minecraftmods.swift.mixins.lithium.shapes.specialized_shapes.VoxelShapesMixin;
...
//                        }
    ...
    public static VoxelShape[] getVanillaModdedVoxelShapePair(AxisAlignedBB box) {
        return new VoxelShape[]{VoxelShapes.create(box), VoxelShapesMixin.create(box)};
    }
}
