package ga.ozli.minecraftmods.swift.common.lithium.shapes;

import net.minecraft.util.AxisRotation; // import net.minecraft.util.math.AxisCycleDirection;
...
public class VoxelShapeAlignedCuboid extends VoxelShapeSimpleCube {
    ...
    public VoxelShapeAlignedCuboid(VoxelShapePart voxels, double minX, double minY, double minZ, double maxX, double maxY, double maxZ, int xRes, int yRes, int zRes) {
    ...
    public VoxelShape withOffset(double x, double y, double z) {
        return new VoxelShapeAlignedCuboid_Offset(this, this.part, x, y, z);
    }
