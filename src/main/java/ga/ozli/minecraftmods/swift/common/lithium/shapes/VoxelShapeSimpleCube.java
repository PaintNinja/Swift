...
public class VoxelShapeSimpleCube extends VoxelShape implements VoxelShapeCaster {
    ...
    public VoxelShape withOffset(double x, double y, double z) {
        return new ga.ozli.minecraftmods.swift.common.lithium.shapes.VoxelShapeSimpleCube(this.part, this.minX + x, this.minY + y, this.minZ + z, this.maxX + x, this.maxY + y, this.maxZ + z);
    }
