package ga.ozli.minecraftmods.swift.mixins.lithium.world.player_chunk_tick;
/*
...
import net.minecraft.world.chunk.Chunk; // import net.minecraft.world.chunk.WorldChunk;
...
public abstract class ThreadedAnvilChunkStorageMixin {
    ...
    @Shadow
    protected abstract void sendChunkDataPackets(ServerPlayerEntity player, Packet<?>[] packets, Chunk chunk);
