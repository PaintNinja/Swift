package ga.ozli.minecraftmods.swift.mixins.lithium.shapes.specialized_shapes;

import ga.ozli.minecraftmods.swift.common.lithium.shapes.VoxelShapeAlignedCuboid;
import ga.ozli.minecraftmods.swift.common.lithium.shapes.VoxelShapeEmpty;
import ga.ozli.minecraftmods.swift.common.lithium.shapes.VoxelShapeSimpleCube;
import net.minecraft.util.math.AxisAlignedBB; // import net.minecraft.util.math.Box;
import net.minecraft.util.math.shapes.BitSetVoxelShapePart; // import net.minecraft.util.shape.BitSetVoxelSet;
import net.minecraft.util.math.shapes.VoxelShapePart; // import net.minecraft.util.shape.VoxelSet;
