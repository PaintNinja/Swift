package ga.ozli.minecraftmods.swift.client.sodium.util;
...
public class UnsafeUtil {
    ...
    /**
     * @return True if {@link ga.ozli.minecraftmods.swift.client.sodium.util.UnsafeUtil#instance()} can be used, otherwise false
     */
